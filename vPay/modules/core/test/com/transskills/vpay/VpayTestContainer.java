...
public class VpayTestContainer extends TestContainer {

    public VpayTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/transskills/vpay/app.properties",
    ...
    public static class Common extends VpayTestContainer {

        public static final VpayTestContainer.Common INSTANCE = new VpayTestContainer.Common();
